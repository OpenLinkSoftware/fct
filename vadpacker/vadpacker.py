...
# Copyright (C) 2012-2019 OpenLink Software <opensource@openlinksw.com>
#
...
def main():
    ...
    optparser = optparse.OptionParser(usage="vadpacker.py [-h] --output PATH [--verbose] [--prefix PREFIX] [--targetprefix PREFIX] [--var [VAR [VAR ...]]] sticker_template [files [files ...]]",
                                      version="Virtuoso VAD Packer 1.3",
                                      description="Copyright (C) 2012-2019 OpenLink Software. Vadpacker can be used to build Virtuoso VAD packages by providing the tool with a sticker template file. Vadpacker supports variable replacement and wildcards for file resources.",
