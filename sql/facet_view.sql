...
create procedure fct_desc_page_head ()
{
  http ('
	...
	<button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#fct-navbar" aria-expanded="false">
	    <span class="sr-only">Toggle navigation</span>
	    <span class="icon-bar"></span>
	    <span class="icon-bar"></span>
	    <span class="icon-bar"></span>
	</button>
	<a class="navbar-brand" href="/fct" title="Faceted Browser">Faceted Browser</a>
	<div id="homelink"></div>
    </div> <!-- navbar-header -->
  ');

  http ('
    <div class="collapse navbar-collapse" id="fct-navbar">
