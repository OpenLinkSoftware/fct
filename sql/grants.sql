...
grant execute on b3s_render_inf_invfp_sas_clauses to SPARQL_SELECT;
...
grant execute on DB.DBA.fct_server_supports_invfp to SPARQL_SELECT;
grant execute on DB.DBA.b3s_render_inf_opts to SPARQL_SELECT;
grant execute on DB.DBA.b3s_render_invfp_opts to SPARQL_SELECT;
grant execute on DB.DBA.b3s_render_sas_opts to SPARQL_SELECT;
...
grant execute on short2float to "SPARQL";
grant execute on rnk_scale to "SPARQL";
grant execute on DB.DBA.IR_SRV to "SPARQL";
grant execute on IR_SRV to "SPARQL";
grant execute on IRI_RANK to "SPARQL";
